(function () {
  ...
  */
  console.log("\nOperation:");
  var operation = justMod2Or3.reduce(function (item, index) {
    return (item + 1) * index;
  }, 0);
  console.log(operation);
  //* parei no video 86 - em 6 minutos
  /*
  ...
  */
  console.log("\nInversed Name:");
  var = isversedName = name.reduceRight(function(acumulado, atual){
    return acumulado + atual;
  });
  console.log(isversedName, name.reverse().join('') );
