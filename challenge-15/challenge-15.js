(function () {
  ...
  */
  ...
  var francisca = new Person("francisca", "souza", 35);
  var joão = new Person("João", "gerson", 25);
  ...
  */
  console.log("\nIdade das pessoas:");
  console.log(francisca.getFullName() + "tem " + francisca.getAge() + " anos.");
  ...
  */
  ...
  francisca.addAge(2);
  console.log(
    francisca.getFullName() + " agora tem " + francisca.addAge(2).getAge() + " anos."
  );
  console.log(
    joao.getFullName() + " agora tem " + joao.addAge(4).getAge() + " anos."
  );
  console.log(
