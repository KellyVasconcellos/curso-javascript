...
*/
var pessoa = { nome: ' Ana Carolina', sobrenome: 'Teixeira', sexo: 'Feminino', idade: 32, altura: 1.60, peso: 60, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Ana Carolina Teixeira!"
...
// Agora, apresente-se ;)
// Olá, eu sou a Ana Carolina Teixeira, tenho 35 anos, 1.60, meu peso é 60 e, só hoje, eu já caminhei 350 metros!".


//parei indo para o video 21.
```
